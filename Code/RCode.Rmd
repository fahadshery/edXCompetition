...
HappyLogRegModel = glm(Happy ~ Income + HouseholdStatus + EducationLevel, data = Train, family=binomial)
...
So let's make our first prediction on the Train dataset by:

```{r}

predictHappiness = predict(HappyLogRegModel, newdata=Test, type="response")
...
#tapply(predictHappiness, Test$Happy, mean)
...
View(sample)
submission = cbind(UserID=Test$UserID, Probability1=predictHappiness)
View(submission)
